...
// Frontend (WunderkindLC.Client/src/types/index.ts) dagi tiplarga mos keluvchi
...
/// (<see cref="WunderkindLC.Application.Services.DocxTemplate"/>).</para>
/// </summary>
...
public class CenterMeta
{
    ...
    /// <summary>Telegram bot ko'rsatiladigan nomi (masalan "WunderkindLC Bot") — UI/ilovada ko'rsatish uchun.</summary>
...
public class BookOrder
{
    ...
    /// HECH QACHON saqlanmaydi (<see cref="WunderkindLC.Application.Services.PaymentFields"/>
...
/* =====================================================================================
 *  KARYERA (Wunderkind Career) — ishga qabul moduli
...
{
    public string Id { get; set; } = Guid.NewGuid().ToString();
    /// <summary>Sahifa sarlavhasi (masalan "Wunderkind o'quv markazi").</summary>
    public string Title { get; set; } = string.Empty;
...
// =====================================================================================
//
//  Bir martalik (yoki takroriy) LOYIHAVIY topshiriqlar — muddat, muhimlik, mas'ul, ichki
//  qadamlar (checklist), izohlar va harakatlar tarixi bilan.
//
