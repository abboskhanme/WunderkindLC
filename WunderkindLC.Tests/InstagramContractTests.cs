...
public class InstagramHardeningTests
{
    ...
    [Theory]
    [InlineData("lc.wunderkindedu.uz", "https://lc.wunderkindedu.uz")]
    [InlineData("https://lc.wunderkindedu.uz", "https://lc.wunderkindedu.uz")]
    [InlineData("  lc.wunderkindedu.uz/  ", "https://lc.wunderkindedu.uz")]
    [InlineData("https://lc.wunderkindedu.uz/admin/marketing", "https://lc.wunderkindedu.uz")]
    ...
    {
        Assert.Equal("https://lc.wunderkindedu.uz",
            InstagramContract.PublicBase(configured, "https", "lc.wunderkindedu.uz"));
    }
    ...
    [InlineData("http://lc.wunderkindedu.uz", "http://lc.wunderkindedu.uz")]
