...
public class InstagramAgentServiceTests
{
    ...
    public void Prompt_bilim_bazasi_matnini_ichiga_oladi()
    {
        ...
        var prompt = InstagramAgentService.BuildSystemPrompt(
            "## Narxlar\nIELTS — 700 000 so'm/oy", "Wunderkind", "");
    ...
    {
        Assert.Contains("«Wunderkind Group»", InstagramAgentService.BuildSystemPrompt("", "Wunderkind Group", ""));
    }
    ...
    public void Salomlashuv_bosh_bolsa_standart_bot_oshkorligi_qoyiladi()
    {
        ...
        Assert.Contains(IgConst.DefaultGreeting, InstagramAgentService.BuildSystemPrompt("", "Wunderkind", ""));
    }

    [Fact]
    public void Sozlangan_salomlashuv_promptga_tushadi()
    {
        var prompt = InstagramAgentService.BuildSystemPrompt("", "Wunderkind", "Men botman 🤖");
    ...
    {
        var prompt = InstagramAgentService.BuildSystemPrompt("   ", "Wunderkind", "");
