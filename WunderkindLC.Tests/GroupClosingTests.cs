...
public class GroupClosingTests
{
    ...
    /// <summary>Repo ildizi (<c>WunderkindLC.slnx</c> yonidagi papka).</summary>
    ...
    /// Test loyihasi <c>WunderkindLC.Server</c> ga bog'lanmagan (csproj'da ProjectReference yo'q),
    /// shuning uchun endpoint MANBA matni bo'yicha qulflanadi.</summary>
    private static string ArchiveMethodSource()
    {
        var src = File.ReadAllText(Path.Combine(
            RepoRoot, "WunderkindLC.Server", "Controllers", "ClassesController.cs"));
